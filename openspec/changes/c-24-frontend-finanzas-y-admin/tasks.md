...
- [ ] 1.2 Add lazy-load imports and routes in Router.tsx for `/liquidaciones`, `/grilla-salarial`, `/facturas`, `/admin/carreras`, `/admin/cohortes`, `/admin/materias`, `/admin/usuarios`, `/admin/auditoria`
- [ ] 1.3 Add nav entries in Layout.tsx for Finanzas and Admin submenus
...
- [ ] 2.4 Create LiquidacionesPage with segmentación tabs (General / NEXO / Factura), tabla de liquidaciones, botón calcular, botón cerrar, historial, export
...
- [ ] 3.4 Create GrillaSalarialPage with 3 tabs: Salarios Base / Plus / Materia-Grupo. Each tab: table + create/edit/delete modals
...
- [x] 4.3 Add hooks
- [ ] 4.4 Create FacturasPage: tabla de facturas + botón crear + dropdown de estado
...
- [x] 5.3 Add hooks
- [ ] 5.4 Create CarrerasPage: ABM carreras
- [ ] 5.5 Create CohortesPage: ABM cohortes filtrado por carrera
- [ ] 5.6 Create MateriasPage: ABM materias filtrado por carrera
...
- [x] 6.3 Add hooks
- [ ] 6.4 Create UsuariosPage: tabla con filtros (nombre, apellido, email, legajo, is_active) + detalle expandible + edición
...
- [x] 7.3 Add hooks
- [ ] 7.4 Create AuditoriaPage with 2 tabs: Dashboard (KPIs, gráficos de métricas) y Log (tabla paginada con filtros)

## 8. Tests

- [ ] 8.1 Write tests for LiquidacionesPage
- [ ] 8.2 Write tests for GrillaSalarialPage
- [ ] 8.3 Write tests for FacturasPage
- [ ] 8.4 Write tests for CarrerasPage, CohortesPage, MateriasPage
- [ ] 8.5 Write tests for UsuariosPage
- [ ] 8.6 Write tests for AuditoriaPage
