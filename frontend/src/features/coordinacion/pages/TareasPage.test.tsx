  ...
  it('lista tareas del usuario', async () => {
    vi.mocked(api.listarTareas).mockResolvedValue({
      items: [
        ...
        { id: '2', tenant_id: 't1', estado: 'En progreso', asignado_a: 'a1', asignado_por: 'a2', materia_id: null, contexto_id: null, descripcion: 'Corregir TP', created_at: '2025-01-02T00:00:00Z', updated_at: '2025-01-02T00:00:00Z' },
      ],
